...
## Easy Setup
Pre-compiled executables can be found in the releases sidebar for both Windows and Intel (pre M1) OSX.  These are from the 1.0 release and currently lack some minor features.  Updates soon I hope...
